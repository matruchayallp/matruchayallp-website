...
const Testimonials = () => {
  const testimonials = [
    {
      quote: "Matruchaya Consultancy made my home loan process incredibly smooth. Their team was always available to answer my questions and guided me through every step.",
      name: "Rajesh Patel",
      location: "Mumbai"
    },
    {
