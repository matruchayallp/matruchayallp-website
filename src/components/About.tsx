      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-8">
            About Matrucahaya LLP
          </h2>
          <div className="prose prose-lg mx-auto">
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">
              At Matrucahaya LLP, we believe that everyone deserves access to the best financial solutions 
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              ...
              need, Matrucahaya LLP is here to guide you every step of the way. Your dreams are our mission.
            </p>
          </div>
        </div>
      </div>
