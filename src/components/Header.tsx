    ...
    <header className="w-full bg-gradient-to-r from-corporate-primary to-corporate-accent2 shadow-xl sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between py-5 px-8">
        <div className="flex items-center gap-4">
          <img src="/favicon.ico" alt="Matruchaya Consultancy LLP Logo" className="w-20 h-20 rounded-lg shadow-lg" />
          <span className="text-xl font-bold text-white tracking-tight drop-shadow-xl ml-3">Matruchaya Consultancy LLP</span>
        </div>
